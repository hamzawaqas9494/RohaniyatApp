    ...
    if (Object.keys(formErrors).length === 0) {
      try {
        const response = await fetch(
          `${BASE_URL}/api/app-form-routes/amliyat_course_form`,
          {
            method: "POST",
            headers: {
          ...
          <KeyboardWrapper>
            <ScrollView>
              ...
              <Text style={mainStyles.description}>
                ...
                لوگ فیض یاب ہو رہے ہیں ۔ آپ روحانی عمیات کورس کرنے کا ارادہ
                رکھتے ہیں تو پہلے استخارہ فرمالیں ۔ ادارے کی طرف سے کروائے جانے
                والے روحانی عملیات کورس میں اعمال کروائے جاتے ہیں ان کے صدقات
                ادا کرنا لازم ہوتا ہے ، بغیر صدقات ادا کئے جانے والے اعمال کے
                پیچھے روحانی قوتیں کام نہیں کرتی ۔ الحمدللہ ادارے کی طرف سے جن
                اعمال کے صدقات ادا کروائے جاتے ہیں ان اعمال کی مکمل روحانی
                نگرانی اور تربیت کی جاتی ہے تاکہ شاگرد کو کسی قسم کی رجعت اور
                مسائل کا سامنا نہ کرنا پڑئے۔ اس فارم کو پُر کر کے اعمال کی تفصیل
                بتائیں تاکہ آپ کو جلد از جلد اعمال شروع کروائے جا سکیں ۔
              </Text>
