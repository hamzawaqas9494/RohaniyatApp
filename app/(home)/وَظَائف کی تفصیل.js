...
// import { htmlBaseStyle, htmlStyles, mainStyles } from "../../style/styleDetails"; // ✅ correct import
...
//       ) : !data ? (
//         <View style={mainStyles.centerContent}>
//           <Text style={mainStyles.noRecordText}>کوئی ریکارڈ نہیں ملا</Text>
//         </View>
//       ) : (
//         <ScrollView>
...
//             />
//           )}
//           <View style={mainStyles.deatilContentWrapper}>
//             <RenderHTML
//               contentWidth={width}
...
import CustomBackground from "../../components/Background/Background";
import YoutubeButton from "../../components/youtubeButton/youtubeVideo";
import { htmlBaseStyle, htmlStyles, mainStyles } from "../../style/styleDetails";
export default function Wazaifkitafseel() {
  const route = useRoute();
  const { id } = route.params;
  const { width } = useWindowDimensions();
  ...
  return (
    <CustomBackground>
      {loading ? (
        ...
        <View style={mainStyles.centerContent}>
          <Text style={mainStyles.noRecordText}>کوئی ریکارڈ موجود نہیں ہے</Text>
        </View>
      ) : (
        <ScrollView>
