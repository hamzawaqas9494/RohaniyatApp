    ...
    <CustomBackground>
      <ScrollView showsVerticalScrollIndicator={false}>
          <View style={mainStyles.container}>
           <Text style={mainStyles.heading}>فرد کی تشخیص کرنے کا طریقہ</Text> 
          <Text style={mainStyles.description}>
            انسانوں کی روحانی تشخیص کرنے کے مختلف طریقے:
          </Text>
          <Text style={mainStyles.heading}>پہنے ہوئے کپڑے سے تشخیص کرنے کا طریقہ:</Text>
          <Text style={mainStyles.description}>
          ...
          <Text style={mainStyles.heading}>کھلا کے تشخیص کرنے کا طریقہ:</Text>
          <Text style={mainStyles.description}>
          ...
          <Text style={mainStyles.heading}>بازو ناپ کے تشخیص کرنے کا طریقہ:</Text>
          <Text style={mainStyles.description}>
