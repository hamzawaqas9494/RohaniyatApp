    ...
    <CustomBackground>
      <ScrollView>
        <View>
          ...
          <Text style={styles.innerheading}>پہنے ہوئے کپڑے سے تشخیص کرنے کا طریقہ:</Text>
          <Text style={styles.description}>
          ...
          <Text style={styles.innerheading}>کھلا کے تشخیص کرنے کا طریقہ:</Text>
          <Text style={styles.description}>
          ...
          <Text style={styles.innerheading}>بازو ناپ کے تشخیص کرنے کا طریقہ:</Text>
          <Text style={styles.description}>
