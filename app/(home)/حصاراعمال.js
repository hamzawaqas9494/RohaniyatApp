    ...
    <CustomBackground>
      <ScrollView>
        <View>
          ...
          <Text style={styles.heading}>روحانی حصار کا مختصر تعارف:</Text>
          <Text style={styles.description}>
          ...
          <Text style={styles.heading}>خواتین کیلئے (ناپاکی کے ایام میں):</Text>
          <Text style={styles.description}>
          ...
          <Text style={styles.heading}>مرد حضرات و خواتین (پاکی کیلئے):</Text>
          <Text style={styles.description}>
            • آیت الکرسی (7 مرتبہ)
