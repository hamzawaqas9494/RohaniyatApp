...
نقوش کئی طرح سےلکھے جاتے ہیںاور کئی اشیاء مثلاََ مختلف دھاتوں، جانوروں کی کھالوں اور ہڈیوں پر ، کئی طرح کے کاغذوں پراور کئی طرح کے کپڑوں پر لکھے جاتے ہیں۔ ہر مقصد کیلئے نقش لکھنے اور استعمال طریقہ علیحدہ ہوتا ہے ، جیسے عملیات کا مزاج ہوتا ہے ویسے ہی نقوش کا بھی مزاج ہوتا ہے نقش لکھنے کیلئے اس کے اصول و قواعد کا خاص خیال رکھنا نہایت ضروری  ہوتا ہے۔ اسی طرح وقت ، سمت ، قلم ، سیاہی کے رنگ کا ، جگہ اور مقام کا خیال بھی رکھا جاتا ہے ہر نقش کی علیحدہ دھونی(خوشبو) ہوتی ہے ۔ نقوش ہر قسم کےمسائل کیلئے لکھے اور استعمال کئے جاتے ہیں۔، جادو کیا بھی جاتا ہے۔ مثبت اور منفی ، خیر اور شر کیلئے یہ عامل پر منحصر ہوتا ہے ۔وہ عامل نقوش کے قواعد و ضوابط کا خیال نہیں رکھتے جنہوں نے جناتی چلے کئے ہوتے ہیں اور جنات سے کام لینا جانتے ہیں وہ خالی کاغذ پر بھی کسی مخلوق کی ڈیوٹی لگا کر کام لے سکتے ہیں ۔ (واللہ اعلم)
          </Text>
          ...
          <Text style={mainStyles.description}>
            ...
            جاتے ہیں، مثلاََ کاغذ، ہرن کی چھلی یا کھال، چینی کی پلیٹ، سونے چاندی
            کی لوح وغیرہ پر، نحس اور منفی اعمال میں کتے کی ہڈی یا کھال، گدھے کی
            کھال، الو کی کھال سرخ یا کالے کاغذ پر آتشی نقش لکھتے وقت عامل کو
          ...
          <Text style={mainStyles.description}>
            ...
            جاتے ہیں، برے اور منفی کاموں کیلئے مثلاََ نفرت، عداوت، زبان بندی
            وغیرہ کیلئے کالے کپڑے میں پیک کر کانٹے دار یا کڑوے درخت کے ساتھ
            باندھے جاتے ہیں۔ بادی نقش لکھتے وقت عامل کسی اونچی جگہ پر بیٹھے
          ...
          <Text style={mainStyles.description}>
            ...
            ستھری زمین یعنی مسجد، دربار یا کھیتوں میں دفن کئے جاتے ہیں۔ برے اور
            منفی کاموں کیلئے قبرستان، مردہ گھاٹ یا کسی کندے مقام پر دفن کئے جاتے
          ...
          <Text style={mainStyles.description}>
            ...
            کو نمی ملتی رہے، اچھے اور مثبت کاموں کیلئے سمندر، تالاب، ندی یا نہر
            وغیرہ میں ڈالے جاتے ہیں، منفی کاموں کیلئے گندے پانی میں ڈالے جاتے
            ہیں۔ آبی تعویز لکھتے وقت عامل کے پاس پانی سے بھرا طشت رکھا ہو، ایک
            ٹانگ بچھا کر لکھے، منہ شمال کی طرف رکھے۔
          </Text>
        </View>
      </ScrollView>
    </CustomBackground>
