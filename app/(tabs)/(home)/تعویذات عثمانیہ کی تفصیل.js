...
export default function TavizatUsmaniaKiTafseel() {
    ...
    const fetchDetails = async () => {
      try {
        const response = await fetch(
          `https://rohaniyatweb-production-99fc.up.railway.app/api/card-data/get-table-data?tableName=tawizatusmaniya&id=${id}`
        );
